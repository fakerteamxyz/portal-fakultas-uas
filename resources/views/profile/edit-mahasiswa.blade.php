                    ...
                    <form method="post" action="{{ route('profile.update') }}" class="mt-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                ...
                                style="border: 4px solid var(--dark); border-radius: 0; padding: 12px 15px; font-size: 1.05rem; box-shadow: 4px 4px 0 rgba(0,0,0,0.1);" autofocus>
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                                <div class="alert alert-warning mt-2 p-2" style="border: 2px solid var(--dark); border-radius: 0;">
                                    <p class="mb-0">
                                        ...
                                        <form method="post" action="{{ route('verification.send') }}" class="d-inline">
                                            @csrf
                                            <button type="submit" class="btn btn-sm btn-link p-0 m-0 align-baseline">
                                ...
                                @if (session('status') === 'verification-link-sent')
                                    <div class="alert alert-success mt-2 p-2" style="border: 2px solid var(--dark); border-radius: 0;">
            ...
            <div class="neo-card mb-4 position-relative" style="transform: rotate(1deg);">
                ...
                <div class="card-body p-4 text-center">
                    <div class="mb-4" style="width: 100px; height: 100px; border: 5px solid var(--dark); background-color: var(--primary); color: white; display: flex; align-items: center; justify-content: center; margin: 0 auto; transform: rotate(-3deg); box-shadow: 6px 6px 0 var(--dark);">
                        <span style="font-weight: 900; font-size: 3rem;">{{ substr($user->name, 0, 1) }}</span>
                    </div>
                    
                    <h4 class="fw-black mb-1">{{ $user->name }}</h4>
                    <p class="mb-3"><span class="neo-badge" style="background-color: var(--secondary);">{{ strtoupper($user->role) }}</span></p>
                    ...
                    <div class="mb-3">
                        <span class="fw-bold">Bergabung sejak:</span> {{ $user->created_at->format('d M Y') }}
                    </div>
                </div>
            </div>
