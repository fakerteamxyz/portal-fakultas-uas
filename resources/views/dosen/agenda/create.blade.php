...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Agenda Baru</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('dosen.agenda.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('kategori_agenda_id') is-invalid @enderror" id="kategori_agenda_id" name="kategori_agenda_id">
                        ...
                        @foreach($kategoris as $kategori)
                            <option value="{{ $kategori->id }}" {{ old('kategori_agenda_id') == $kategori->id ? 'selected' : '' }}>{{ $kategori->nama }}</option>
                        @endforeach
                    </select>
